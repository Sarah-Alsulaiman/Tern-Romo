 ...
 */
   public void init(Context context, Tern tern) {
      ...
      this.robot = new Romo(this, context);
 ...
 */
   ...
   public void trace(tern.romo.rt.Process p, String message) {
      try {
   ...
   public void error(tern.romo.rt.Process p, String message) {
      Log.i(TAG, message);
      this.message = message;
      repaint();
   }
